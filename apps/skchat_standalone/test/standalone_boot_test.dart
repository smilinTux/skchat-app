...
import 'package:skchat_standalone/src/standalone_app.dart';
import 'package:skchat_standalone/src/standalone_scaffold.dart';

/// The standalone boot gate (reconciled spec 3.2 step 4, first job):
/// `skchat_standalone` boots headless and the hosted module runs with
/// `shell == null`. This is the guarantee that the standalone runner never
/// depends on a shell being present.
...
void main() {
  ...
  testWidgets('SkchatStandaloneApp boots headless and mounts skchat_ui', (
    tester,
  ) async {
